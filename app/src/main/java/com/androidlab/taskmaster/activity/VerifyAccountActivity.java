...
public class VerifyAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText usernameEditText = (EditText) findViewById(R.id.usernameVerify);
        usernameEditText.setText(email);

        Button verifyAccountVerifyButton = findViewById(R.id.verifyButton);
        verifyAccountVerifyButton.setOnClickListener(v ->
        {
            String username= usernameEditText.getText().toString();
            String verificationCode = ((EditText)findViewById(R.id.passwordVerify)).getText().toString();
            ...
            Amplify.Auth.confirmSignUp(username,
                    ...
                    failure ->
                    {
                        ...
                        runOnUiThread(() ->
                        {
                            Toast.makeText(VerifyAccountActivity.this, " Verify account failed!!", Toast.LENGTH_LONG).show();
                        });
                    }
            );
        });
